...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-700 via-purple-600 to-pink-500 flex justify-center items-center p-6">
          ...
          <div className="mt-8 bg-gray-50 rounded-2xl p-6 shadow-md">
            ...
            <div className="mt-6 p-4 rounded-xl bg-white border">
              ...
              <p className="text-gray-600">
                {result.prediction === "Spam"
                  ? "⚠️ This message appears to contain spam-like characteristics. Avoid clicking unknown links, sharing personal information, or sending money without verification."
